    ...
    return (
      <div className="flex items-center flex-col min-h-screen pb-7 px-2">
        ...
        <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
          <label className="text-white font-medium mt-2 mb-2">Nome dos links</label>
          ...
          <Input type="url"
           ...
           {nameInput !== '' && (
            ...
            <article className="w-11/22 max-w-lg flex flex-col items-center justify-between bg-zinc-900 rounded px-1 py-3"
